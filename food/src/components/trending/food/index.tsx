...
export function CardHorizontalFood({ food }: { food: FoodProps}) {
    return (
        <Pressable className='flex flex-col rounded-xl relative'>
            ...
            />
            <View className='flex flex-row bg-neutral-900/90 gap-1 rounded-full absolute top-2 right-3 px-2 py-2 py-1 items-center justify-center'>
            ...
            <Text className='text-neutral-600'>R$ {food.time} - R$ {food.delivery}</Text>
        </Pressable>
    );
}